 ...
 */
final class Version20200108185205 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultation CHANGE rendez_vous_id rendez_vous_id INT DEFAULT NULL, CHANGE prochain_rv prochain_rv VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE autre autre VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE facturation CHANGE consultation_id consultation_id INT DEFAULT NULL, CHANGE montant_paye montant_paye INT DEFAULT NULL, CHANGE remise remise INT DEFAULT NULL');
        $this->addSql('ALTER TABLE hospitalisation CHANGE facturation_id facturation_id INT DEFAULT NULL');
    }
}
