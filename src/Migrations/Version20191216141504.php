 ...
 */
final class Version20191216141504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hospitalisation ADD patient_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_67C059596B899279 ON hospitalisation');
        $this->addSql('ALTER TABLE hospitalisation DROP patient_id');
    }
}
